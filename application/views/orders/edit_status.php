    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          ...
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('orders/update_status/'.$order_id) ?>" method="post" class="form-horizontal">
              <div class="box-body">
                      ...
                      <?php foreach ($order_data['order_item'] as $key => $val): ?>
                       ...
                       <tr id="row_<?php echo $x; ?>">
                         <td>
                          ...
                          <td>
                            <input type="text" name="sale_rate[]" id="sale_rate_<?php echo $x; ?>" class="form-control" required onkeyup="getTotal(<?php echo $x; ?>)" value="<?php echo $val['sale_rate'] ?>" autocomplete="off">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <select type="text" class="form-control" id="status" name="status">
                        <option value="approved" <?php if($order_data['order']['status'] == 'approved'){echo 'selected';}?>>Approved</option>
                        <option value="draft" <?php if($order_data['order']['status'] == 'draft'){echo 'selected';}?>>Draft</option>
                      </select>
                    </div>
                  </div>
...
<script type="text/javascript">
              ...
              // console.log(reponse.x);
               var html = '<tr id="row_'+row_id+'">'+
                   '<td>'+ 
                    ...
                    '<td><input type="text" name="sale_rate[]" id="sale_rate_'+row_id+'" class="form-control" onkeyup="getTotal('+row_id+')" required><input type="hidden" name="sale_rate_value[]" id="sale_rate_value_'+row_id+'" class="form-control"></td>'+

                    '<td><input type="text" name="amount[]" id="amount_'+row_id+'" class="form-control" onkeyup="onChangeAmount('+row_id+')" readonly><input type="hidden" name="amount_value[]" id="amount_value_'+row_id+'" class="form-control"></td>'+
  ...
  function getTotal(row = null) {
    if(row) {
      ...
      var sale_rate = Number($("#sale_rate_"+row).val());
      $("#sale_rate_value_"+row).val(sale_rate);

      var total = Number($("#sale_rate_value_"+row).val()) * Number($("#qty_"+row).val());
  ...
  function getProductData(row_id)
  {
    ...
    if(product_id == "") {
      ...
      $("#sale_rate_"+row_id).val("");
      $("#sale_rate_value_"+row_id).val("");
      ...
      $.ajax({
        ...
        success:function(response) {
          ...
          $("#sale_rate_"+row_id).val(response.price);
          $("#sale_rate_value_"+row_id).val(response.price);
