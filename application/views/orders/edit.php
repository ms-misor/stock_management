              ...
              <div class="box-body">
                ...
                <div class="col-md-4 col-xs-12 pull pull-left">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="customer_name" name="customer_name" placeholder="Enter Customer Name" value="<?php echo $order_data['order']['customer_name'] ?>" autocomplete="off" readonly/>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="customer_address" name="customer_address" placeholder="Enter Customer Address" value="<?php echo $order_data['order']['customer_address'] ?>" autocomplete="off" readonly>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="customer_phone" name="customer_phone" placeholder="Enter Customer Phone" value="<?php echo $order_data['order']['customer_phone'] ?>" autocomplete="off" readonly>
                    </div>
                  </div>
                </div>
                       ...
                       <tr id="row_<?php echo $x; ?>">
                         <td>
                          <select class="form-control select_group product" data-row-id="row_<?php echo $x; ?>" id="product_<?php echo $x; ?>" name="product[]" style="width:100%;" onchange="getProductData(<?php echo $x; ?>)">
                            ...
                            <input type="hidden" id="old_amount_<?php echo $x; ?>" value="<?php echo $val['amount']; ?>">
                          </td>
                          ...
                          <td>
                            <input type="text" name="sale_rate[]" id="sale_rate_<?php echo $x; ?>" class="form-control" disabled value="<?php echo $val['sale_rate'] ?>" autocomplete="off">
                            <input type="hidden" name="sale_rate_value[]" id="sale_rate_value_<?php echo $x; ?>" class="form-control" value="<?php echo $val['sale_rate'] ?>" autocomplete="off">
                          </td>

                          <td><input type="number" name="return_qty[]" id="return_qty_<?php echo $x; ?>" class="form-control" onkeyup="getTotalByReturnQty(<?php echo $x; ?>)" value="<?php echo $val['return_qty'] ?>" autocomplete="off"></td>

                          <td>
                            <input type="text" name="amount[]" id="amount_<?php echo $x; ?>" class="form-control" onkeyup="onChangeAmount(<?php echo $x; ?>)" value="<?php echo $val['amount'] ?>" autocomplete="off" readonly>
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="discount" name="discount" placeholder="Discount" onkeyup="onChangeAmount()" value="<?php echo $order_data['order']['discount'] ?>" autocomplete="off">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="paid_status" class="col-sm-5 control-label">Return Qty Show</label>
                    <div class="col-sm-7">
                      <select type="text" class="form-control" id="return_qty_print" name="return_qty_print">
                        <option value="1" <?php if($order_data['order']['return_qty_print'] == 1){echo "selected";}?>>Show</option>
                        <option value="0" <?php if($order_data['order']['return_qty_print'] == 0){echo "selected";}?>>Hide</option>
                      </select>
                      <input type="hidden" name="" id="order_id" value="<?php echo $order_data['order']['id'];?>">
                    </div>
                  </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    //                 '<td><input type="text" name="amount[]" id="amount_'+row_id+'" class="form-control" onkeyup="onChangeAmount('+row_id+')"><input type="hidden" name="amount_value[]" id="amount_value_'+row_id+'" class="form-control"></td>'+
    ...
    $("#return_qty_print").on('change', function() {

      var return_qty_print = $("#return_qty_print").val();
      var order_id = $("#order_id").val();

      var action_url = base_url+'orders/change_return_qty_print_staus';
      ...
      $.ajax({
          ...
          success:function(response) {
            ...
            if(response){
              alert("Successfully updated the return quantity show/hide status.");
              location.reload();
            }else{
  ...
  function getTotalByReturnQty(row = null) {
    if(row) {

      var qty =  Number($("#qty_"+row).val());
      var old_amount =  Number($("#old_amount_"+row).val());
      var return_qty =  Number($("#return_qty_"+row).val());

      if(return_qty > qty){

        $("#return_qty_"+row).val("");
        alert("Returnn qty must be lesser than actual qty !");

      }else{

        var unit_amount = Number(old_amount / qty);
        var unit_amnt = Number(unit_amount.toFixed(2));
        var remaining_qty = Number(qty - return_qty);
        var final_amount = Number(unit_amnt * remaining_qty);
  ...
  function getProductData(row_id)
  {
    ...
    alert("Can't change any product when updating as paid !");
    location.reload();
