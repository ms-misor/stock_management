    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          ...
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('products/item_edit/'.$id) ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">

                <?php echo validation_errors(); ?>

                <div class="form-group">
                  <label for="product_id">Stock Product</label>
                  <select class="form-control select_group" id="product_id" name="product_id" disabled="true">
                    <?php foreach ($products as $k => $v): ?>
                      <option value="<?php echo $v['id'] ?>" <?php if($item_info->product_id == $v['id']) { echo "selected='selected'"; } ?> ><?php echo $v['name'] ?></option>
                    <?php endforeach ?>
                  </select>
                </div>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select_group" id="big_unit" name="big_unit">
                    ...
                    <?php foreach ($big_units as $k => $v): ?>
                      <option value="<?php echo $v['big_unit_id'] ?>" <?php if($item_info->big_unit == $v['big_unit_id']) { echo "selected='selected'"; } ?> ><?php echo $v['name'] ?></option>
                    <?php endforeach ?>
                  </select>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="big_unit_qty" name="big_unit_qty" placeholder="Enter big unit qty" value="<?php echo $item_info->big_unit_qty; ?>"  autocomplete="off" />
                </div>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select_group" id="small_unit" name="small_unit" required>
                    ...
                    <?php foreach ($small_units as $k => $v): ?>
                      <option value="<?php echo $v['id'] ?>" <?php if($item_info->small_unit == $v['id']) { echo "selected='selected'"; } ?> ><?php echo $v['name'] ?></option>
                    <?php endforeach ?>
                  </select>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="small_unit_qty" name="small_unit_qty" placeholder="Enter small unit qty" value="<?php echo $item_info->small_unit_qty; ?>" required autocomplete="off" />
                </div>

                <div class="form-group">
                  <label for="qty">Total Qty</label>
                  <input type="text" class="form-control" id="qty" name="qty" placeholder="Enter Qty" value="<?php echo $item_info->qty; ?>" autocomplete="off" readonly />
                </div>

                <div class="form-group">
                  <label for="price">Unit Price</label>
                  <input type="number" class="form-control" id="price" name="price" min="0" step="0.01" placeholder="Enter price" value="<?php echo $item_info->price; ?>" autocomplete="off" onkeyup="priceCalculate()"/>
                </div>

                <div class="form-group">
                  <label for="total_price">Total Price</label>
                  <input type="number" class="form-control" id="total_price" name="total_price" placeholder="Enter total price" value="<?php echo $item_info->total_price; ?>" required autocomplete="off" readonly/>
                </div>

                <div class="form-group">
                  <label for="qty">Purchase Date</label>
                  <input type="text" class="form-control datepicker" id="purchase_date" name="purchase_date" placeholder="Enter Date" value="<?php echo $item_info->purchase_date; ?>" autocomplete="off" />
                </div>
