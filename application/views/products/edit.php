          ...
          <form role="form" action="<?php base_url('users/update') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="price" name="price" placeholder="Enter price" value="<?php echo $product_data['price']; ?>" autocomplete="off" required readonly/>
                </div>

                <div class="form-group">
                  <label for="qty">Qty</label>
                  <input type="number" class="form-control" id="qty" name="qty" placeholder="Enter Qty" value="<?php echo $product_data['qty']; ?>" autocomplete="off" readonly/>
                </div>

                <div class="form-group">
                  <label for="store">Unit</label>
                  <select class="form-control select_group" id="unit" name="unit" required>
                    <option value="">Select Unit</option>
                    <?php foreach ($units as $k => $v): ?>
                      <option value="<?php echo $v['id'] ?>" <?php if($product_data['unit'] == $v['id']) { echo "selected='selected'"; } ?> ><?php echo $v['name'] ?></option>
                    <?php endforeach ?>
                  </select>
                </div>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select_group" id="category" name="category" required>
                    ...
                    <?php foreach ($category as $k => $v): ?>
                      <option value="<?php echo $v['id'] ?>" <?php if($v['id'] == $product_data['category_id']) { echo 'selected="selected"'; } ?>><?php echo $v['name'] ?></option>
                    <?php endforeach ?>
                  </select>
                </div>
