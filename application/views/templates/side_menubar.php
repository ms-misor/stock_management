    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <!-- <?php if($user_permission): ?>
          ...
          <li id="unitsetupNav">
            <a href="<?php echo base_url('units_setup/') ?>">
              <i class="fa fa-files-o"></i> <span>Big Units Setup</span>
            </a>
          </li>
            ...
            <li class="treeview" id="mainItemNav">
              ...
              <ul class="treeview-menu">
                <?php //if(in_array('createProduct', $user_permission)): ?>
                  <li id="addItemNav"><a href="<?php echo base_url('products/item_create') ?>"><i class="fa fa-circle-o"></i> Add Item</a></li>
                <?php //endif; ?>
                <?php //if(in_array('updateProduct', $user_permission) || in_array('viewProduct', $user_permission) || in_array('deleteProduct', $user_permission)): ?>
                <li id="manageItemNav"><a href="<?php echo base_url('products/item_list') ?>"><i class="fa fa-circle-o"></i> Manage Items</a></li>
                <?php //endif; ?>
              </ul>
            </li>
          <?php //endif; ?>
          ...
          <?php if(in_array('viewReports', $user_permission)): ?>
            <li id="catagoryReportNav">
              <a href="<?php echo base_url('category_reports/') ?>">
                <i class="glyphicon glyphicon-stats"></i> <span>Category reports</span>
              </a>
            </li>
          <?php endif; ?>
