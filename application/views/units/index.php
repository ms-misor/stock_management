      ...
      <form role="form" action="<?php echo base_url('units/update') ?>" method="post" id="updateUnitForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="edit_unit_name" name="edit_unit_name" placeholder="Enter brand name" autocomplete="off">
          </div>
          <div class="form-group">
...
{ 
  ...
  var submit_url = base_url + 'units/fetchUnitDataById/'+id;
